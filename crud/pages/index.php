...
<head>
    ...
    <style>
        ...
        .card {
            ...
            overflow: hidden;
            background: #ffffff;
            /* Background terang untuk card */
            transition: transform 0.2s;
            max-width: 300px;
            /* Mengatur lebar maksimum card */
            margin: 0 auto;
            /* Mengatur margin agar card berada di tengah */
        }
        ...
        .card img {
            height: 150px;
            /* Mengubah tinggi gambar menjadi lebih kecil */
            object-fit: cover;
        }

        .card-body {
            position: relative;
            /* Mengatur posisi relatif untuk penempatan elemen di dalamnya */
        }
...
<body>
    <div class="container-fluid p-0">
        ...
        <div class="tm-hero d-flex justify-content-center align-items-center"
            style="background-image: url('../img/hero.jpg'); background-size: cover; background-position: center; min-height: 200px;">
            <form method="GET" class="mb-3">
                <div class="input-group">
                    <input type="text" name="search" class="form-control rounded-start" placeholder="Cari album..."
        ...
        <div class="row justify-content-center mx-2">
            <?php while ($album = $result->fetch_assoc()): ?>
                <div class="col-md-3 mb-4">
                    <div class="card" onclick="window.location.href='daftar_foto.php?album_id=<?= $album['album_id'] ?>'">
                        <?php
                        ...
                        <img src="<?= $imagePath ?>" class="card-img-top"
                            alt="<?= htmlspecialchars($album['namaalbum']) ?>">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-folder-open"></i>
                                <?= htmlspecialchars(shortenString($album['namaalbum'], 20)) ?></h5>
                            <p class="card-text"><?= htmlspecialchars(shortenString($album['deskripsi'], 20)) ?></p>
                            <?php if ($isLoggedIn): ?>
                                <!-- Tampilkan tombol edit hanya jika pengguna merupakan pemilik album atau admin -->
                                <?php if ($currentUserId == $album['user_id'] || $isAdmin): ?>
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    ...
                    <p>Gallery-Z adalah platform galeri foto yang memungkinkan pengguna untuk mengunggah, membagikan,
                        dan mengeksplorasi foto-foto luar biasa dari seluruh dunia. Kami berkomitmen untuk memberikan
                        pengalaman berbagi foto yang mudah dan menyenangkan untuk semua pengguna.</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-12 px-5 text-right">
                    Dirancang oleh <a href="http://localhost/ABSEN/home/tmpl.php?id=22" class="tm-text-gray"
                        rel="sponsored" target="_parent">Nanasi</a>
                </div>
            </div>
        </div>
    </footer>
...
<?php
// Fungsi untuk mempersingkat string
